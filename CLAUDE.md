...
| `ted-greene-modern-chord-progressions` | Modern Chord Progressions | Ted Greene | 68 | No chapters — every page standalone. Pick randomly from p.4–68. Guitar / chord vocabulary. |
...
| `evolution-of-blast-beats` | The Evolution of Blast Beats | Derek Roddy | 6 (excerpts) | Partial ingest — 6 pages: p.1 Skank Beats / p.2 Punk / p.3 Blast Beats / p.4 Traditional Blast Variations / p.5 Double Bass Workout — 32nd Note Spurts / p.6 Additional Excerpt |
| `art-of-brushes-thigpen` | The Art of Brushes | Ed Thigpen | 23 | Brush technique. Pick randomly from p.1–23 — all pages usable. |
| `rod-morgenstein-drum-set-warm-ups` | Drum Set Warm-Ups | Rod Morgenstein | 98 | Offset +6 (book p + 6 = rendered p) / 34 lessons / L1–15 hands (p.7–31) / L16–21 feet + coordination (p.32–57) / L22–30 accents + flams + cymbals (p.58–76) / L31–34 mirror images + crossovers + combinations (p.77–94) / Skip p.95+ (about author) |
...
| `scale-studies-jazz-guitar-stone` | Scale Studies for Jazz Guitar | Rick Stone | 24 | Offset +4 (book p + 4 = rendered p). Skip rendered pp.1–5 (cover/TOC/intro/chapter title). Skip p.24 (About the Author). Chapters: Major Scales p.6–7 / Melodic Minor p.8–9 / Harmonic Minor p.10–11 / Harmonic Major p.12–13 / Diminished p.14 / Whole-Tone p.15 / Major Pentatonic p.16–17 / Minor 69 Pentatonic p.18–19 / Dom7 Pentatonic p.20–21 / Dom7(b9) Pentatonic p.22–23 |
| `modern-rudimental-swing-solos` | Modern Rudimental Swing Solos | Charley Wilcoxon | 34 | Every page is a standalone snare solo. Pick randomly from p.1–34. |
| `converge-axe-to-fall` | Converge — Axe to Fall | — | 5 | Guitar tab — single song, all pages usable. Viewer: Converge-Axe-to-Fall.html |
| `converge-concubine` | Converge — Concubine | — | 3 | Guitar tab — single song, all pages usable. Viewer: Converge-Concubine.html |
| `converge-dark-horse` | Converge — Dark Horse | — | 6 | Guitar tab — single song, all pages usable. Viewer: Converge-Dark-Horse.html |
| `converge-drop-out` | Converge — Drop Out | — | 5 | Guitar tab — single song, all pages usable. Viewer: Converge-Drop-Out.html |
| `converge-first-light` | Converge — First Light | — | 2 | Guitar tab — single song, all pages usable. Viewer: Converge-First-Light.html |
| `converge-hum-of-hurt` | Converge — Hum of Hurt | — | 10 | Guitar tab — single song, all pages usable. Viewer: Converge-Hum-of-Hurt.html |
| `converge-to-feel-something` | Converge — To Feel Something | — | 7 | Guitar tab — single song, all pages usable. Viewer: Converge-To-Feel-Something.html |
| `converge-under-duress` | Converge — Under Duress | — | 5 | Guitar tab — single song, all pages usable. Viewer: Converge-Under-Duress.html |
| `converge-versus` | Converge — Versus | — | 7 | Guitar tab — single song, all pages usable. Viewer: Converge-Versus.html |
| `converge-worms-will-feed` | Converge — Worms Will Feed | — | 7 | Guitar tab — single song, all pages usable. Viewer: Converge-Worms-Will-Feed.html |
